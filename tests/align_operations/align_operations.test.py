...
try:
    ...
    class TestAddon(unittest.TestCase):
        ...
        def test_align_operations_AlignSXMargin_active_island(self):
            ...
            for i in self.selectedIslands:
                self.assertAlmostEqual(i.BBox().left(), activeIsland_left)

        def test_align_operations_AlignSXMargin_uv_space(self):
            bpy.context.scene.uv_align_distribute.relativeItems = "UV_SPACE"
            bpy.ops.uv.align_left_margin(self.override)
            uv_left_border = 0.0
            for i in self.selectedIslands:
                self.assertAlmostEqual(i.BBox().left(), uv_left_border)

        def test_align_operations_AlignSXMargin_3d_cursor(self):
            bpy.context.scene.uv_align_distribute.relativeItems = "CURSOR"
            bpy.ops.uv.align_left_margin(self.override)
            cursor_x = 0.75
            for i in self.selectedIslands:
                self.assertAlmostEqual(i.BBox().left(), cursor_x)
    ...
    ###########################################################################
        ...
        def test_align_operations_AlignRXMargin_active_island(self):
            ...
            for i in self.selectedIslands:
                self.assertAlmostEqual(i.BBox().right(), activeIsland_right)
        ...
        def test_align_operations_AlignRXMargin_uv_space(self):
            ...
            uv_right_border = 1.0
            for i in self.selectedIslands:
                self.assertAlmostEqual(i.BBox().right(), uv_right_border)
        ...
        def test_align_operations_AlignRXMargin_3d_cursor(self):
            ...
            cursor_x = 0.75
            for i in self.selectedIslands:
                self.assertAlmostEqual(i.BBox().right(), cursor_x)
    ...
    ###########################################################################
        ...
        def test_align_operations_AlignTopMargin_active_island(self):
            ...
            for i in self.selectedIslands:
                self.assertAlmostEqual(i.BBox().top(), activeIsland_top)
        ...
        def test_align_operations_AlignTopMargin_uv_space(self):
            ...
            uv_top_border = 1.0
            for i in self.selectedIslands:
                self.assertAlmostEqual(i.BBox().top(), uv_top_border)
        ...
        def test_align_operations_AlignTopMargin_3d_cursor(self):
            ...
            for i in self.selectedIslands:
                ...
                self.assertAlmostEqual(i.BBox().top(), cursor_y)
    ...
    ###########################################################################
        ...
        def test_align_operations_AlignLowMargin_active_island(self):
            ...
            for i in self.selectedIslands:
                self.assertAlmostEqual(i.BBox().bottom(), activeIsland_low)
        ...
        def test_align_operations_AlignLowMargin_uv_space(self):
            ...
            uv_low_border = 0.0
            for i in self.selectedIslands:
                self.assertAlmostEqual(i.BBox().bottom(), uv_low_border)
        ...
        def test_align_operations_AlignLowMargin_3d_cursor(self):
            ...
            cursor_y = 0.25
            for i in self.selectedIslands:
                self.assertAlmostEqual(i.BBox().bottom(), cursor_y)
    ...
    ###########################################################################
        ...
        def test_align_operations_AlignHAxis_active_island(self):
            ...
            for i in self.selectedIslands:
                self.assertAlmostEqual(i.BBox().center().y, activeIsland_cy)
        ...
        def test_align_operations_AlignHAxis_uv_space(self):
            ...
            uv_cy = 0.5
            for i in self.selectedIslands:
                self.assertAlmostEqual(i.BBox().center().y, uv_cy)
        ...
        def test_align_operations_AlignHAxis_3d_cursor(self):
            ...
            cursor_y = 0.25
            for i in self.selectedIslands:
                self.assertAlmostEqual(i.BBox().center().y, cursor_y)
    ...
    ###########################################################################
        ...
        def test_align_operations_AlignVAxis_active_island(self):
            ...
            for i in self.selectedIslands:
                self.assertAlmostEqual(i.BBox().center().x, activeIsland_cx)
        ...
        def test_align_operations_AlignVAxis_uv_space(self):
            ...
            uv_cx = 0.5
            for i in self.selectedIslands:
                self.assertAlmostEqual(i.BBox().center().x, uv_cx)
        ...
        def test_align_operations_AlignVAxis_3d_cursor(self):
            ...
            cursor_x = 0.75
            for i in self.selectedIslands:
                self.assertAlmostEqual(i.BBox().center().x, cursor_x)
    ...
    ###########################################################################
        ...
        def test_align_operations_AlignRotation_active_island(self):
            ...
            for i in self.selectedIslands:
                ...
                # self.assertAlmostEqual(i.angle(), activeIsland_angle, places=2)
        ...
        def test_align_operations_EqualizeScale_active_island(self):
            ...
            for i in self.selectedIslands:
                self.assertAlmostEqual(i.size().width, activeIsland_size.width,
                                        places=4)
                self.assertAlmostEqual(i.size().height, activeIsland_size.height,
                                        places=4)
